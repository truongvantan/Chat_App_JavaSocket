package com.client.customswing.blurHash;
...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        this.imageDown = new ImageIcon(getClass().getResource("/com/client/icon/down.png")).getImage();
        this.imageCancel = new ImageIcon(getClass().getResource("/com/client/icon/cancel.png")).getImage();
        this.imageFile = new ImageIcon(getClass().getResource("/com/client/icon/file.png")).getImage();
