...
public class ComponentResizer extends MouseAdapter {
     ...
     *
     * @param dragInsets Insets specifying which borders are eligible to be resized.
     * @param snapSize Specify the dimension to which the border will snap to when being dragged. Snapping occurs at the halfway mark.
     * @param components components to be automatically registered
     */
     ...
     *
     * @param snapSize Dimension object allows you to separately spcify a horizontal and vertical snap size.
     */
