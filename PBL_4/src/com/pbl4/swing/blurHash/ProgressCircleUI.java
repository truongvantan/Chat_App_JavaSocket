package com.pbl4.swing.blurHash;
...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        this.imageDown = new ImageIcon(getClass().getResource("/com/pbl4/icon/down.png")).getImage();
        this.imageCancel = new ImageIcon(getClass().getResource("/com/pbl4/icon/cancel.png")).getImage();
        this.imageFile = new ImageIcon(getClass().getResource("/com/pbl4/icon/file.png")).getImage();
