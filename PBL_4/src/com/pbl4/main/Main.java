package com.pbl4.main;

import com.formdev.flatlaf.intellijthemes.FlatArcIJTheme;
import com.pbl4.event.EventImageView;
import com.pbl4.event.EventMain;
import com.pbl4.event.PublicEvent;
import com.pbl4.service.Service;
import com.pbl4.swing.ComponentResizer;
...
public class Main extends javax.swing.JFrame{
    ...
    private void init() {
        setIconImage(new ImageIcon(getClass().getResource("/com/pbl4/icon/icon.png")).getImage());
        ...
        Service.getInstance().clientProcess();
    }
...
//                Service.getInstance().getClient()
    ...
    private void initComponents() {
        ...
        loading = new com.pbl4.form.Loading();
        login = new com.pbl4.form.Login();
        view_Image = new com.pbl4.form.View_Image();
        home = new com.pbl4.form.Home();
        ...
        cmdMinimize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pbl4/icon/minimize.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pbl4/icon/close.png"))); // NOI18N
        ...
        titleLayout.setVerticalGroup(
            ...
            .addGroup(titleLayout.createSequentialGroup()
                ...
                .addGroup(titleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmdClose, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
    ...
    private com.pbl4.form.Home home;
    private com.pbl4.form.Loading loading;
    private com.pbl4.form.Login login;
    private javax.swing.JPanel title;
    private com.pbl4.form.View_Image view_Image;
    // End of variables declaration//GEN-END:variables

//    @Override
//    public void run() {
//        new Service().clientProcess();
//    }
}
