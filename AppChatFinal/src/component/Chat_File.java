...
public class Chat_File extends javax.swing.JPanel {
   ...
   private void downloadFile(String fileName, int fileID){ //gửi request dến server, để down file về lưu vào folder
    ...
    public void InitIconFile(){
     //icon file
//      word = new ImageIcon(getClass().getResource("/icon/word.png")).getImage();
//      txt = new ImageIcon(getClass().getResource("/icon/txt.png")).getImage();
//      rar = new ImageIcon(getClass().getResource("/icon/rar.png")).getImage();
//      pp = new ImageIcon(getClass().getResource("/icon/pp.png")).getImage();
//      pdf = new ImageIcon(getClass().getResource("/icon/pdf.png")).getImage();
//      exe = new ImageIcon(getClass().getResource("/icon/exe.png")).getImage();
